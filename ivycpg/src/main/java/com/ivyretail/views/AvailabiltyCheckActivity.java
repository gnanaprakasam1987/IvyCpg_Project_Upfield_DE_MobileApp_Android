...
public class AvailabiltyCheckActivity extends IvyBaseActivityNoActionBar {
    ...
    private void initializeViews() {
        ...
        etShelfPiece.setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.REGULAR));
        etShelfCase.setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.REGULAR));
        etShelfOuter.setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.REGULAR));
        ...
        ((TextView) findViewById(R.id.tvTitleAvaialabilty)).setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.BOLD));
        ((TextView) findViewById(R.id.tvTitleCurrentStock)).setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.BOLD));
        ...
        ((TextView) findViewById(R.id.tvTitlePriceCheck)).setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.BOLD));
        ...
        if (mProductMasterBO != null) {
            ...
            mReason.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    mProductMasterBO.setReasonID(reString
                            .getReasonID());
        ...
        protected void onPostExecute(Boolean result) {
            ...
            if (result == Boolean.TRUE) {
                bmodel.outletTimeStampHelper.updateTimeStampModuleWise(SDUtil
                        .now(SDUtil.TIME));
                Toast.makeText(AvailabiltyCheckActivity.this,
