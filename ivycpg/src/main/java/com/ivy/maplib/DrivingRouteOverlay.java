...
public class DrivingRouteOverlay extends OverlayManager {
     ...
     */
    public DrivingRouteOverlay(BaiduMap baiduMap,Marker stMarker,Marker enMarker) {
        super(baiduMap);
        startMarker=stMarker;
        endMarker=enMarker;
...
//            }
    ...
    public boolean onRouteNodeClick(int i) {
        if (mRouteLine.getAllStep() != null
            ...
            Commons.print("baidumapsdk,"+ "DrivingRouteOverlay onRouteNodeClick");
        }
        return false;
    }
