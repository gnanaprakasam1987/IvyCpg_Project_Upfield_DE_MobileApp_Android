...
public class ActivationHelper {
    ...
    public int doActivationAtHttp() {
        ...
        try {
            ...
            Commons.printInformation(SynchronizationHelper.VERSION_NAME + bmodel.getApplicationSubVersionName());
            ...
            ksp.addParam(SynchronizationHelper.VERSION_NAME, bmodel.getApplicationSubVersionName());
