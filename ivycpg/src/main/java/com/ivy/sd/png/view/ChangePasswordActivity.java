...
//        btnClose = (Button) findViewById(R.id.btnClose);
        ...
        btnClose.setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.REGULAR));
    ...
    class uploadPassword extends AsyncTask<Integer, Integer, Integer> {
        ...
        protected Integer doInBackground(Integer... params) {
            ...
            try {
                ...
                Vector<String> responseVector = bmodel.synchronizationHelper.getUploadResponse(jsonObject.toString(), null, appendUrl);
