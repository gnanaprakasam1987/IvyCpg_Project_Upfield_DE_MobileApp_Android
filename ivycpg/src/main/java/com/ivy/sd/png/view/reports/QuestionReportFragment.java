...
public class QuestionReportFragment extends Fragment {
    ...
    private Vector<QuestionReportBO> mylist;
    private View view;
    MyAdapter mSchedule;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_questionreport, container, false);
        ...
        lvwplist = (ListView) view.findViewById(R.id.lv_availcheckreport_list);
        return view;
    ...
    public void onStart() {
        // TODO Auto-generated method stub
        super.onStart();
        mylist = new Vector<QuestionReportBO>();
        bmodel.reportHelper.loadQuestionReport();
        mylist.addAll(bmodel.reportHelper.getQuestionReport());
