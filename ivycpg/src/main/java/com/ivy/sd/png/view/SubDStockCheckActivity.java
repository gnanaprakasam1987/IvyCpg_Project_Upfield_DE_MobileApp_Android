...
import com.ivy.cpg.view.stockcheck.StockCheckContractor;
import com.ivy.cpg.view.stockcheck.StockCheckFragment;
import com.ivy.cpg.view.stockcheck.StockCheckPresenterImpl;
...
public class SubDStockCheckActivity extends IvyBaseActivityNoActionBar implements View.OnClickListener,
        BrandDialogInterface, TextView.OnEditorActionListener, MOQHighlightDialog.savePcsValue {
...
//                        findViewById(R.id.moqTitle).setVisibility(View.GONE);
//                    else {
//                        ((TextView) findViewById(R.id.moqTitle)).setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.MEDIUM));
//                        if (bmodel.labelsMasterHelper.applyLabels(findViewById(
//                                R.id.moqTitle).getTag()) != null)
//                            ((TextView) findViewById(R.id.moqTitle))
//                                    .setText(bmodel.labelsMasterHelper
//                                            .applyLabels(findViewById(
//                                                    R.id.moqTitle)
//                                                    .getTag()));
...
//                    ((LinearLayout) row.findViewById(R.id.llSrp)).setVisibility(View.GONE);
             ...
             /*   holder.imageView_stock.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        ...
                        Intent intent = new Intent(SubDStockCheckActivity.this,
               ...
               /* if (bmodel.configurationMasterHelper.SHOW_CUSTOM_KEYBOARD_NEW) {
                    ...
                    holder.caseQty.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (dialogCustomKeyBoard == null || !dialogCustomKeyBoard.isDialogCreated()) {
                                dialogCustomKeyBoard = new CustomKeyBoard(SubDStockCheckActivity.this, holder.caseQty);
                                dialogCustomKeyBoard.show();
                                dialogCustomKeyBoard.setCancelable(false);
             ...
             /*   if (bmodel.configurationMasterHelper.SHOW_CUSTOM_KEYBOARD_NEW) {
                    ...
                    holder.foc.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (dialogCustomKeyBoard == null || !dialogCustomKeyBoard.isDialogCreated()) {
                                dialogCustomKeyBoard = new CustomKeyBoard(SubDStockCheckActivity.this, holder.foc);
                                dialogCustomKeyBoard.show();
                                dialogCustomKeyBoard.setCancelable(false);
                    ...
                    holder.foc.setOnTouchListener(new View.OnTouchListener() {
                        public boolean onTouch(View v, MotionEvent event) {
                            if (bmodel.configurationMasterHelper.SHOW_SIH_IN_PNAME) {
                                strProductObj = "[SIH :"
                                        + holder.productObj.getSIH() + "] "
...
//                                        .getSrp())
                            ...
                            double tot = (holder.productObj.getOrderedCaseQty() * holder.productObj
                                    .getCsrp())
//                                    + (holder.productObj.getOrderedPcsQty() * holder.productObj.getSrp())
                                    + (holder.productObj.getOrderedOuterQty() * holder.productObj
                                    .getOsrp());
                            String strTotal = bmodel.formatValue(tot) + "";
                            holder.total.setText(strTotal);
               ...
               /* if (bmodel.configurationMasterHelper.SHOW_CUSTOM_KEYBOARD_NEW) {
                    ...
                    holder.pcsQty.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (dialogCustomKeyBoard == null || !dialogCustomKeyBoard.isDialogCreated()) {
                                dialogCustomKeyBoard = new CustomKeyBoard(SubDStockCheckActivity.this, holder.pcsQty);
                                dialogCustomKeyBoard.show();
                                dialogCustomKeyBoard.setCancelable(false);
              ...
              /*  if (bmodel.configurationMasterHelper.SHOW_CUSTOM_KEYBOARD_NEW) {
                    ...
                    holder.outerQty.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            if (dialogCustomKeyBoard == null || !dialogCustomKeyBoard.isDialogCreated()) {
                                dialogCustomKeyBoard = new CustomKeyBoard(SubDStockCheckActivity.this, holder.outerQty);
                                dialogCustomKeyBoard.show();
                                dialogCustomKeyBoard.setCancelable(false);
...
//                                .getSrp())
              ...
              /*  holder.so.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (bmodel.configurationMasterHelper.ALLOW_SO_COPY) {
//                            holder.pcsQty.setText(holder.so.getText().toString());
                            updateValue();
                        }
                    }
                });*/

              /*  holder.socs.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        if (bmodel.configurationMasterHelper.ALLOW_SO_COPY) {
               ...
               /* holder.salesReturn.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
              ...
              /*  holder.iv_info.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        bmodel = (BusinessModel) getApplicationContext();
                        bmodel.setContext(SubDStockCheckActivity.this);
                        ...
                        if (bmodel.configurationMasterHelper.IS_SCHEME_DIALOG || bmodel.configurationMasterHelper.IS_PRODUCT_SCHEME_DIALOG) {
                            if (bmodel.schemeDetailsMasterHelper
                                ...
                                Toast.makeText(SubDStockCheckActivity.this,
                            ...
                            Intent intent = new Intent(SubDStockCheckActivity.this, ProductSchemeDetailsActivity.class);
...
//        private TextView moq;
    ...
    private void calculateSONew(ProductMasterBO productObj, int SOLogic, SubDStockCheckActivity.ViewHolder holder) {
...
//            ((TextView) findViewById(R.id.distValue)).setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.LIGHT));
        ...
        if (vw == mBtn_Search) {
            ...
            if (bmodel.configurationMasterHelper.SHOW_SALES_RETURN_IN_ORDER && bmodel.retailerMasterBO.getRpTypeCode().equals("CASH")) {
                if (!orderHelper.isPendingReplaceAmt()) {
                    ...
                    Toast.makeText(SubDStockCheckActivity.this, getResources().getString(R.string.return_products_price_not_matching_total_replacing_product_price), Toast.LENGTH_SHORT).show();
                }
            } else
                onnext();
            ...
            if (bmodel.hasOrder()) {
               ...
               /* if (bmodel.configurationMasterHelper.IS_ORD_SR_VALUE_VALIDATE &&
                ...
                if (bmodel.configurationMasterHelper.IS_MOQ_ENABLED) {
                    ...
                    if (count > 0) {
                        new SubDStockCheckActivity.MOQConfigEnabled().execute();
                        count = 0;
                        return;
                    }
                }
                ...
                if (bmodel.configurationMasterHelper.IS_MUST_SELL
                    ...
                    if (dialog == null) {
                        dialog = new MustSellReasonDialog(
                                SubDStockCheckActivity.this, false,
    ...
    private void nextBtnSubTask() {
        ...
        if (bmodel.configurationMasterHelper.SHOW_BATCH_ALLOCATION && bmodel.configurationMasterHelper.IS_SIH_VALIDATION) {
            ...
            Intent init = new Intent(SubDStockCheckActivity.this, OrderDiscount.class);
            init.putExtra("ScreenCode", screenCode);
            startActivity(init);
            overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
            finish();
        } else if (bmodel.configurationMasterHelper.IS_INITIATIVE) {
            Intent init = new Intent(SubDStockCheckActivity.this,
            ...
            Intent i = new Intent(SubDStockCheckActivity.this,
            ...
            Intent i = new Intent(SubDStockCheckActivity.this, OrderSummary.class);
            i.putExtra("ScreenCode", screenCode);
            startActivity(i);
            overridePendingTransition(R.anim.trans_left_in, R.anim.trans_left_out);
            finish();
    ...
    protected Dialog onCreateDialog(int id) {
        switch (id) {
            case 0:
                ...
                break;
            case 1:
                AlertDialog.Builder builder1 = new AlertDialog.Builder(SubDStockCheckActivity.this)
                        .setIcon(null)
                        .setCancelable(false)
                        .setTitle(
                                getResources().getString(
                        ...
                        .setPositiveButton(getResources().getString(R.string.ok),
                                new DialogInterface.OnClickListener() {
                                    public void onClick(DialogInterface dialog,
                                        ...
                                        new SubDStockCheckActivity.SaveStock().execute();
