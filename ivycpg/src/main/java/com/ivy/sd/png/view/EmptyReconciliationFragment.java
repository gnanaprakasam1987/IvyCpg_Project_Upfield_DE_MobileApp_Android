...
public class EmptyReconciliationFragment extends IvyBaseFragment implements
    ...
    private void showPopup(final Activity context, View anchor) {
        ...
        for (SKUTypeBO type : bmodel.mEmptyReconciliationhelper.getSkuTypeBO()) {
    ...
    private void nextButtonClick() {
        try {
            if (bmodel.mEmptyReconciliationhelper.isDataToSave()) {
                if (bmodel.mEmptyReconciliationhelper.checkDataTosave())
    ...
    private void onLoadModule() {
        ArrayList<ProductMasterBO> items = bmodel.mEmptyReconciliationhelper
                .getProductBO();
