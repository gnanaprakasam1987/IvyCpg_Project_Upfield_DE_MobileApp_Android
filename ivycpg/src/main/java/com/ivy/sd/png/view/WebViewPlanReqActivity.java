 ...
 */
public class WebViewPlanReqActivity extends IvyBaseActivityNoActionBar implements ApplicationConfigs {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bmodel.reportHelper.downloadWebViewPlanAuthUrl("WEBVIEW_PLN_REQ");
        if (!bmodel.reportHelper.getWebViewAuthUrl().equals(""))
            new DownloadToken().execute();
        else
            Toast.makeText(WebViewPlanReqActivity.this, getResources().getString(R.string.error_message_bad_url), Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            Intent in = new Intent(WebViewPlanReqActivity.this, HomeScreenActivity.class);
            startActivity(in);
            finish();
            return true;
        }
    ...
    class DownloadToken extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            builder = new AlertDialog.Builder(WebViewPlanReqActivity.this);
        ...
        protected void onPostExecute(String token) {
            ...
            if (!token.equals("")) {
                bmodel.reportHelper.downloadWebViewPlanUrl("WEBVIEW_PLN_REQ");
                ...
                if (!bmodel.synchronizationHelper.getAuthErroCode().equals(SynchronizationHelper.AUTHENTICATION_SUCCESS_CODE)) {
                    ...
                    if (errorMsg != null) {
                        Toast.makeText(WebViewPlanReqActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(WebViewPlanReqActivity.this, getResources().getString(R.string.data_not_downloaded), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(WebViewPlanReqActivity.this, R.string.token_error, Toast.LENGTH_LONG).show();
                }
            }
