...
import com.ivy.sd.png.provider.OfflinePlanHelper;
...
public class OfflinePlanningActivity extends IvyBaseActivityNoActionBar {
    ...
    private final int[] mToday = new int[3];
    ...
    private void initializeViews() {
        ...
        tvRetailerCount.setTypeface(bmodel.configurationMasterHelper.getFontBaloobhai(ConfigurationMasterHelper.FontType.REGULAR));
        tvNonField.setTypeface(bmodel.configurationMasterHelper.getFontBaloobhai(ConfigurationMasterHelper.FontType.REGULAR));
    ...
    private void setValues() {
        ...
        SearchView.SearchAutoComplete searchAutoComplete = (SearchView.SearchAutoComplete) mSearchRetailer.findViewById(android.support.v7.appcompat.R.id.search_src_text);
    ...
    class RetailerAdapter extends BaseAdapter implements Filterable {
        ...
        public RetailerAdapter(Vector<RetailerMasterBO> items) {
            this.items = items;
    ...
    private void loadCalendar() {
        ...
        madapter = new CalendarAdapter(this, mToday[1], mToday[2], metrics) {
            @Override
    ...
    public abstract class CalendarAdapter extends BaseAdapter {
        ...
        private int mTitleHeight, mDaysShown;
        private double mDayHeight;

        private CalendarAdapter(Context c, int month, int year,
        ...
        private void populateMonth() {
            ...
            // mDayHeight = (mDisplayMetrics.heightPixels - containerHeight() - (rows * 8) - getBarHeight()) / (rows - 1);
                            ...
                            if (holder.isValid) {
                                try {
                                    ...
                                    if ((size == 0 && dateFormatGeneral.parse(holder.calBO.getCal_date()).after(new Date())) || size != 0) {
                                        String dayOfTheWeek = String.valueOf(android.text.format.DateFormat.format("EEEE", new Date(dateStr)));
