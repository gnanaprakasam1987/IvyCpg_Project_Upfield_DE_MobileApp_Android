    ...
    class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public ViewHolder(View v) {
                super(v);
                text_slab_name = (TextView) v.findViewById(R.id.text_slab_name);
                text_type = (TextView) v.findViewById(R.id.text_type);
                text_value = (TextView) v.findViewById(R.id.text_value);
                label_type = (TextView) v.findViewById(R.id.label_type);
                label_value = (TextView) v.findViewById(R.id.label_value);
                imageView_free_products = (ImageView) v.findViewById(R.id.imageView_free_products);
                imageView_Available = (ImageView) v.findViewById(R.id.ivAvailable);

                cardView = (CardView) v.findViewById(R.id.card);

                text_slab_name.setTypeface(businessModel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.MEDIUM));
                text_type.setTypeface(businessModel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.MEDIUM));
                text_value.setTypeface(businessModel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.MEDIUM));

                label_type.setTypeface(businessModel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.LIGHT));
                label_value.setTypeface(businessModel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.LIGHT));
