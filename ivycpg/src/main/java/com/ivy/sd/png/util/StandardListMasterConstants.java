...
public class StandardListMasterConstants {
	...
	public static final String MENU_SELLER_MAPVIEW_REPORT = "MENU_SELLER_MAPVIEW_RPT";
	public static final String MENU_SELLER_PERFOMANCE_REPORT = "MENU_SELLER_PERORM_RPT";
