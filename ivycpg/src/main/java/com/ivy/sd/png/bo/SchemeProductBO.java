...
public class SchemeProductBO {
	...
	/**
	 * @param quantityActualCalculated
	 *            the quantityActualCalculated to set
	 */
	...
	/**
	 * @param quantityMaxiumCalculated
	 *            the quantityMaxiumCalculated to set
	 */
