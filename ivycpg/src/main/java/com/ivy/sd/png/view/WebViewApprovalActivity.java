...
/**
 * Created by mansoor.k on 23-02-2018.
 */
public class WebViewApprovalActivity extends IvyBaseActivityNoActionBar implements ApplicationConfigs {
    WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bmodel.reportHelper.downloadWebViewPlanAuthUrl("WEBVIEW_APPR");
        if (!bmodel.reportHelper.getWebViewAuthUrl().equals(""))
            new DownloadToken().execute();
        else
            Toast.makeText(WebViewApprovalActivity.this, getResources().getString(R.string.error_message_bad_url), Toast.LENGTH_LONG).show();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == android.R.id.home) {
            Intent in = new Intent(WebViewApprovalActivity.this, HomeScreenActivity.class);
            startActivity(in);
            finish();
            return true;
        }
    ...
    class DownloadToken extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            builder = new AlertDialog.Builder(WebViewApprovalActivity.this);
        ...
        protected void onPostExecute(String token) {
            ...
            if (!token.equals("")) {
                bmodel.reportHelper.downloadWebViewPlanUrl("WEBVIEW_APPR");
                ...
                if (!bmodel.synchronizationHelper.getAuthErroCode().equals(SynchronizationHelper.AUTHENTICATION_SUCCESS_CODE)) {
                    ...
                    if (errorMsg != null) {
                        Toast.makeText(WebViewApprovalActivity.this, errorMsg, Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(WebViewApprovalActivity.this, getResources().getString(R.string.data_not_downloaded), Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(WebViewApprovalActivity.this, R.string.token_error, Toast.LENGTH_LONG).show();
                }
            }
