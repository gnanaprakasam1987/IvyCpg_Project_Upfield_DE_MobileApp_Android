...
/**
 * Created by hanifa.m on 7/14/2017.
 */

public class CsSchemeDetailFragment extends IvyBaseFragment {
    ...
    private void updateSchemeView(String productid) {
        ...
        if (parentIdList != null) {
            for (Integer parentId : parentIdList) {
                ...
                int slabWidth = ((mTotalScreenWidth) * 20) / 100;
    ...
    private HorizontalScrollView addViewSchemeFreeeLogicNew(int schemeparentId) {
        LinearLayout.LayoutParams layoutParams1 = new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        layoutParams1.setMargins(0, 10, 0, 40);
                ...
                if (freeProductList != null && freeProductList.size() > 0) {
                    ...
                    if (isAmountDiscAvailable) {
                        if (childView1 == null) {
                            ...
                            childView1.setLayoutParams(new TableLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));
                            TextView amountTitleTV = getTextViewTitle(false, Gravity.LEFT, false);
                            amountTitleTV.setLayoutParams(new TableLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));
                        ...
                        LinearLayout subChildView1 = new LinearLayout(ctxt);
                        subChildView1.setOrientation(LinearLayout.HORIZONTAL);
                        subChildView1.setLayoutParams(new TableLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));
                        subChildView1.addView(amountTV);

                        if (i == 0) {
                            mAddViewLayout.addView(childView1);
                            mAddViewLayout.addView(subChildView1);
                        }
                    ...
                    if (isPercentageDiscAvailable) {
                        if (childView2 == null) {
                            ...
                            childView2.setLayoutParams(new TableLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));
                        ...
                        LinearLayout subChildView2 = new LinearLayout(ctxt);
                        subChildView2.setOrientation(LinearLayout.HORIZONTAL);
                        subChildView2.setLayoutParams(new TableLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT, 1f));
                        subChildView2.addView(percentTV);


                        if (i == 0) {
                            mAddViewLayout.addView(childView2);
                            mAddViewLayout.addView(subChildView2);
                        }
