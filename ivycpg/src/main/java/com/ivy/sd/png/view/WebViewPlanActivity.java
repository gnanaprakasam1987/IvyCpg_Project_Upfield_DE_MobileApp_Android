...
//          // (title support click)
        ...
        bmodel.reportHelper.downloadWebViewPlanAuthUrl();
    ...
    class DownloadToken extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            customProgressDialog(builder, WebViewPlanActivity.this, getResources().getString(R.string.Authenticating));
        ...
        protected void onPostExecute(String token) {
            ...
            if (!token.equals("")) {
                bmodel.reportHelper.downloadWebViewPlanUrl();
