...
public class SOreportFragment extends Fragment {
    ...
    public void onStart() {
        ...
        try {
            ...
            browser.loadUrl(bmodel.reportHelper.getWebReportUrl() + bmodel.userMasterHelper.getUserMasterBO().getUserid());//"http://192.168.1.155/IvyCPG/IvyCPG_Piramal_Ind_Web/dayreport/Index");
