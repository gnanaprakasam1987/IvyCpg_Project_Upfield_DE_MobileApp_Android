...
public class CS_CommonPrintHelper {
    ...
    private static String TAG_PRODUCT_FREE_QTY_PIECE = "free_qty";
    ...
    private int mFreeProductPieceQtyTotal;
    ...
    public static CS_CommonPrintHelper getInstance(Context context) {
        if (instance == null) {
            instance = new CS_CommonPrintHelper(context);
        }
        return instance;
    }
    ...
    private Vector<CS_CommonPrintHelper.AttributeListBO> mAttributeList;
                ...
                switch (event) {
                    case XmlPullParser.START_TAG:
                        if (name.equals("line")) {
                            ...
                            if (group_name != null) {
                                CS_CommonPrintHelper.AttributeListBO attr = new CS_CommonPrintHelper.AttributeListBO();
    ...
    private String getTotalWithQty(String label) {
        ...
        for (CS_CommonPrintHelper.AttributeListBO attr : mAttributeList) {
            mProductValue = "";
            ...
            } else if (attr.getAttributeName().equalsIgnoreCase(TAG_PRODUCT_FREE_QTY_PIECE)) {
                mProductValue = mFreeProductPieceQtyTotal + "";
     ...
     */
    private void loadProducts(Vector<CS_CommonPrintHelper.AttributeListBO> mAttrList, StringBuilder sb, String isLoadSchemeFreeProduct, Vector<ProductMasterBO> productList, String product_name_single_line) {
        ...
        for (ProductMasterBO prod : mOrderedProductList) {
            ...
            for (CS_CommonPrintHelper.AttributeListBO attr : mAttrList) {
                ...
                if (attr.getAttributeName().equalsIgnoreCase(TAG_PRODUCT_CODE)) {
                    ...
                    mProductValue = prod.getCsFreePiece() + "";
                    mFreeProductPieceQtyTotal = mFreeProductPieceQtyTotal + prod.getCsFreePiece();
                } else if (attr.getAttributeName().equalsIgnoreCase(TAG_PRODUCT_QTY_TOTAL_IN_PIECE)) {
                    mProductValue = (prod.getOrderedPcsQty()
                    ...
                    double lineValue = (prod.getOrderedOuterQty() * prod.getMRP())
                            + (prod.getOrderedCaseQty() * prod.getMRP())
                            + (prod.getOrderedPcsQty() * prod.getMRP());
     ...
     * @param isLoadSchemeFreeProduct - indicate to load scheme product
     */
    private void loadProductsWithBatch(Vector<CS_CommonPrintHelper.AttributeListBO> mAttrList, StringBuilder sb, String isLoadSchemeFreeProduct, Vector<ProductMasterBO> productList, String product_name_single_line) {
    ...
    private void loadSchemeDiscount(Vector<CS_CommonPrintHelper.AttributeListBO> mAttrList, String product_name_single_line, StringBuilder sb) {
        int mLengthUptoPName;
    ...
    /**
     * Bill level discount from scheme
     */
    private void getBillLevelDiscount() {
     ...
     */
    private void printEmptyReturn(Vector<CS_CommonPrintHelper.AttributeListBO> mAttrList, StringBuilder sb) {
