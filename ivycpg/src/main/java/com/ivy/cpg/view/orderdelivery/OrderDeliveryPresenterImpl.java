...
public class OrderDeliveryPresenterImpl implements OrderDeliveryContractor.OrderDeliveryPresenter {
    ...
    public void doPrintActivity(String orderId) {
        bmodel.mCommonPrintHelper.xmlRead(".xml", false,orderDeliveryHelper.preparePrintData(context,orderId) , null,null);
    ...
    public class UpdateOrderDeliveryTable extends AsyncTask<Void,Void,Boolean> {
        ...
        protected void onPostExecute(Boolean isSuccess) {
            if (isSuccess) {
                ...
                bmodel.mCommonPrintHelper.xmlRead(".xml", false,orderDeliveryHelper.getOrderedProductMasterBOS() , null,null);
