...
public class ShelfShareActivity extends IvyBaseActivityNoActionBar {
    ...
    private final View.OnClickListener mShelfCreateListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (mBlockCount == 0 || mShelfCount == 0
                ...
                Toast.makeText(ShelfShareActivity.this,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (toolbar != null) {
            ((TextView) findViewById(R.id.tv_toolbar_title)).setTypeface(FontUtils.getFontRoboto(this,FontUtils.FontType.REGULAR));
        ...
        mBtnCancel.setTypeface(FontUtils.getFontRoboto(this,FontUtils.FontType.REGULAR));
        mBtnCreate.setTypeface(FontUtils.getFontRoboto(this,FontUtils.FontType.REGULAR));
        mBtnDone.setTypeface(FontUtils.getFontRoboto(this,FontUtils.FontType.REGULAR));
     ...
     */
        ...
        Commons.print("ShelfShareActivity in createBrandColor," +
    ...
    private void populateShelf(boolean withExistingData) {
        ...
        for (int i = 0; i < mShelfCount; i++) {
            ...
            TableRow tableRow = new TableRow(ShelfShareActivity.this);
