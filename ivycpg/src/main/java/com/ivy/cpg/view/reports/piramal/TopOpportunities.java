 ...
 */
public class TopOpportunities extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_topopportunities, container,
                false);
        ...
        ((TextView) view.findViewById(R.id.tv_avg_values)).setTypeface(bmodel.configurationMasterHelper.getFontRoboto(ConfigurationMasterHelper.FontType.MEDIUM));
    ...
    public void onStart() {
        super.onStart();
        mylist = ReportHelper.getInstance(getActivity()).downloadOppRetailersReport();
