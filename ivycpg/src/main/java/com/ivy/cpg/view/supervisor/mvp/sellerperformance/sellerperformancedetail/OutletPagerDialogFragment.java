...
public class OutletPagerDialogFragment extends DialogFragment {
    ...
    private SellerPerformanceDetailPresenter sellerPerformanceDetailPresenter;

    ArrayList<RetailerBo> visitedRetailers = new ArrayList<>();


    public OutletPagerDialogFragment(SellerPerformanceDetailPresenter sellerPerformanceDetailPresenter){
        this.sellerPerformanceDetailPresenter = sellerPerformanceDetailPresenter;
    }
