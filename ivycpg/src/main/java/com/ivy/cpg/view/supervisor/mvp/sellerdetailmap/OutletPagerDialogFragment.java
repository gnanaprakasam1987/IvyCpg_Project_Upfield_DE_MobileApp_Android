...
//    private CircleIndicator circleIndicator;
    ...
    ArrayList<ArrayList<RetailerBo>> visitedRetailerList =new ArrayList<>();
...
//        visitedRetailerList = sellerMapViewPresenter.getVisitedRetailerList();
...
//                updateState(scrollState);
    ...
    public class VisitedOutletInfoAdapter extends RecyclerView.Adapter<VisitedOutletInfoAdapter.MyViewHolder> {
        ...
        public void onBindViewHolder(MyViewHolder holder, final int position) {
            ...
            holder.tvInTime.setText(convertMillisToTime(visitedRetailers.get(position).getTimeIn()));
            holder.tvOutTime.setText(convertMillisToTime(visitedRetailers.get(position).getTimeOut()));
