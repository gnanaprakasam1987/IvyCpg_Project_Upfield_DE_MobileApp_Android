...
//        FLog.setMinimumLoggingLevel(FLog.VERBOSE);
    ...
    public Tab privateThreadsTab() {
        return new Tab(co.chatsdk.ui.R.string.conversations, co.chatsdk.ui.R.drawable.ic_action_private, privateThreadsFragment());
    }

    @Override
    public Tab publicThreadsTab() {
        return new Tab(co.chatsdk.ui.R.string.chat_rooms, co.chatsdk.ui.R.drawable.ic_action_public, publicThreadsFragment());
    }

    @Override
    public Tab contactsTab() {
        return new Tab(co.chatsdk.ui.R.string.contacts, co.chatsdk.ui.R.drawable.ic_action_contacts, contactsFragment());
    }

    @Override
    public Tab profileTab() {
        return new Tab(co.chatsdk.ui.R.string.profile, co.chatsdk.ui.R.drawable.ic_action_user, ProfileFragment.newInstance());
    }
