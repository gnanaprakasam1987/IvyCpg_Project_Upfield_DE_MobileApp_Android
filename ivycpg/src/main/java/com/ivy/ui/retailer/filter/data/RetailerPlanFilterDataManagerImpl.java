        ...
        return Single.fromCallable(new Callable<ArrayList<String>>() {
            ...
            public ArrayList<String> call() throws Exception {
                ...
                if (planFilterBo.getIsNotVisited() > 0)
                    queryStrng.append(" inner join DatewisePlan as dwp on dwp.EntityId = rm.RetailerID and dwp.Date = ").append(StringUtils.getStringQueryParam(planFilterBo.getSelectedDate())).append(" and dwp.VisitStatus = 'PLANNED'");
