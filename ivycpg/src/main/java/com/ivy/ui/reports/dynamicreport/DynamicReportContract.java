...
public interface DynamicReportContract {
    ...
    interface DynamicReportView extends BaseIvyView {
        void setReportData(HashMap<String, HashMap<String, String>> fieldList, HashMap<String, HashMap<String, HashMap<String, String>>> dataMap, ArrayList<String> headerList);
