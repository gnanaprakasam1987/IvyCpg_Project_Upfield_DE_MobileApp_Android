package com.ivy.calendarlibrary.weekview;
...
import static com.ivy.calendarlibrary.weekview.WeekViewUtil.isSameDay;
import static com.ivy.calendarlibrary.weekview.WeekViewUtil.today;
...
public class WeekView extends View {
    ...
    public WeekView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mTimeTextColor = a.getColor(R.styleable.WeekView_headerColumnTextColor, mHeaderColumnTextColor);
    ...
    private void init() {
        ...
        mDefaultEventColor = Color.parseColor("#81d4fd");
    ...
    public void setTimeTextPaint(int timeTextPaint) {
        mTimeTextColor = timeTextPaint;
